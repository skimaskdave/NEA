...
")
    ...
    Public Sub CreateNewPatient()
        ...
        Console.Clear()
        Console.ForegroundColor = ConsoleColor.Green
        Console.WriteLine("Patient " & firstName & " " & surname & " has been added.")
        Console.ForegroundColor = ConsoleColor.Gray
...
")
    ...
    Public Sub PrintHistory()
        ...
        Dim sqlAddDis As New Odbc.OdbcCommand("select additionaldisabilities from patients where patientid = ?", Module1.GetConnection)
        sqlAddDis.Parameters.AddWithValue("patientid", patientID)
        ...
        Dim sqlNotes As New Odbc.OdbcCommand("select notes, date from patientbooking where patientid = ? order by date", Module1.GetConnection)
        sqlNotes.Parameters.AddWithValue("patientid", patientID)
