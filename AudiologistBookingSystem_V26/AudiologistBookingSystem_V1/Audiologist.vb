...
WHERE meeting.meetingid = meetingattendants.meetingid AND meetingattendants.audiologistid = ? AND meeting.date >= ?", Module1.GetConnection)
    ...
    Public Sub CancelMeeting(ByVal startTime As TimeSpan, ByVal endTime As TimeSpan, ByVal startDate As Date, ByVal endDate As Date)
        ...
        Dim sqlFindMeetings As New Odbc.OdbcCommand("SELECT DISTINCT meeting.meetingid FROM meeting, meetingattendants WHERE meeting.date >= ? AND meeting.date <= ? AND meetingattendants.audiologistid = ?", Module1.GetConnection)
        sqlFindMeetings.Parameters.AddWithValue("meeting.date", stringHandling.SQLDate(startDate))
        sqlFindMeetings.Parameters.AddWithValue("meeting.date", stringHandling.SQLDate(endDate))
        sqlFindMeetings.Parameters.AddWithValue("meetingattendants.audiologistid", audiologistID)
        rsFindMeetings = sqlFindMeetings.ExecuteReader
        While rsFindMeetings.Read
            Dim sqlCancelMeeting As New Odbc.OdbcCommand("delete from meetingattendants where meetingid = ? and audiologistid = ?", Module1.GetConnection)
            sqlCancelMeeting.Parameters.AddWithValue("meetingid", rsFindMeetings("meetingid"))
            sqlCancelMeeting.Parameters.AddWithValue("audiologistid", audiologistID)
    ...
    Public Sub RearrangeRepairs(ByVal startTime As TimeSpan, ByVal endTime As TimeSpan, ByVal startDate As Date, ByVal endDate As Date)
        ...
        Dim sqlFindRepairs As New Odbc.OdbcCommand("SELECT repairsid, DATE, starttime, endtime FROM repairs WHERE audiologistid = ? AND DATE >= ? AND DATE <= ?", Module1.GetConnection)
        sqlFindRepairs.Parameters.AddWithValue("audiologistid", audiologistID)
        sqlFindRepairs.Parameters.AddWithValue("date", stringHandling.SQLDate(startDate))
        sqlFindRepairs.Parameters.AddWithValue("date", stringHandling.SQLDate(endDate))
        ...
        While rsFindRepairs.Read
            ...
            audChange = ChooseNewAud.RandomAudSelection(sTime, eTime, ChooseNewAud.GetWeekDay(repDate.DayOfWeek))
            audChange.GetAudiologistInfo()
            Dim sqlChangeRepairs As New Odbc.OdbcCommand("update repairs set audiologistid = ? where repairsid = ?", Module1.GetConnection)
            sqlChangeRepairs.Parameters.AddWithValue("audiologistid", audChange.ReturnAudiologistID)
            sqlChangeRepairs.Parameters.AddWithValue("repairsid", repairsID)
    ...
    Public Sub RearrangeAppointment(ByVal startTime As TimeSpan, ByVal endTime As TimeSpan, ByVal startDate As Date, ByVal endDate As Date)
        ...
        Dim sqlFindAppointments As New Odbc.OdbcCommand("SELECT bookingid, date, starttime, endtime FROM patientbooking WHERE audiologistid = ? AND DATE >= ? AND DATE <= ?", Module1.GetConnection)
        sqlFindAppointments.Parameters.AddWithValue("audiologistid", audiologistID)
        sqlFindAppointments.Parameters.AddWithValue("date", stringHandling.SQLDate(startDate))
        sqlFindAppointments.Parameters.AddWithValue("date", stringHandling.SQLDate(endDate))
        ...
        While rsFindAppointments.Read
            ...
            audChange = ChooseNewAud.RandomAudSelection(sTime, eTime, ChooseNewAud.GetWeekDay(appDate.DayOfWeek))
            audChange.GetAudiologistInfo()
            Dim sqlChangeApp As New Odbc.OdbcCommand("update patientbooking set audiologistid = ? where bookingid = ?", Module1.GetConnection)
            sqlChangeApp.Parameters.AddWithValue("audiologistid", audChange.ReturnAudiologistID)
            sqlChangeApp.Parameters.AddWithValue("bookingid", bookingID)
    ...
    Public Sub CreateNewAud()
        ...
        Console.Clear()
        Console.WriteLine("Create New Audiologist...")
        ...
        Dim sqlInsertAudiologist As New Odbc.OdbcCommand("INSERT INTO audiologists(firstname, surname, phonenumber, email) VALUES(?, ?, ?, ?)", Module1.GetConnection)
...
")
    ...
    Public Sub ChangePhoneNumber(ByVal telNum As String)
        ...
        sqlChangeAudTel.Parameters.AddWithValue("phonenumber", telNum)
