Public Class Patient
    ...
    Public Function GetPatientInfo(ByVal conn As System.Data.Odbc.OdbcConnection) As Boolean
        Dim choice As Integer = CreateOrSearch()
        Select Case choice
            Case 1 'create new patient
                ...
                While flags(0) = False Or flags(1) = False Or flags(2) = False Or flags(3) = False Or flags(4) = False Or flags(5) = False
                    ...
                    End Select
                End While
                Dim sqlAddPatient As New Odbc.OdbcCommand("insert into patients(firstname, surname, postcode, housenumbername, phonenumber, email, dob, additionaldisabilties, company, processor, implant)
values('" & firstName & "', '" & surname & "', '" & postcode & "', '" & houseNumber & "', '" & phoneNumber & "', '" & email & "', '" & stringHandling.SQLDate(dob) & "', '" & additionalDisabilities & "', '" & company & "', '" & processor & "', '" & implant & "')", conn)
    ...
    Private Function PrintCreatePatient() As Integer
...
")
    ...
    Private Function CreateOrSearch() As Integer
        Console.CursorVisible = False
        Dim currentChoice As Integer = 1
        Dim choice As ConsoleKey
        Console.Clear()
