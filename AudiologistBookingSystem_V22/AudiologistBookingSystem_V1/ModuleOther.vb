...
")
    ...
    Sub CancelAnnualLeave()
        ...
        aud.AddAnnualLeave(startDate, endDate, Module1.GetConnection)
        Console.WriteLine(aud.ReturnAnnualLeaveLeft & " days left")

        aud.CancelAnnualLeave(DateDiff(DateInterval.Day, startDate, endDate), startDate, Module1.GetConnection)
