...
0. Back")
    ...
    Sub BookPatient() 'specific audiologist
        ...
        pat.GetPatientInfo(pat.CreateOrSearch)
        pat.PrintHistory()
    ...
    Sub BookAnnualLeave()
        ...
        End Select
        Console.Clear()
        If alBooking.CheckAnnualLeaveCanHappen(startDate, endDate, startTime, endTime) = True Then
            alBooking.BookAnnualLeave(startTime, endTime, startDate, endDate, personalAppointment)
