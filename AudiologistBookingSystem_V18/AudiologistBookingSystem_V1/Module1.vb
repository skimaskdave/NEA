...
0. Back")
    ...
    Friend Function GetConnection() As OdbcConnection
...
")
    ...
    Public Sub SearchAudiologists()
        ...
        Dim sqlGetAuds As New Odbc.OdbcCommand("select audiologistid, firstname, surname from audiologists order by firstname", conn)
